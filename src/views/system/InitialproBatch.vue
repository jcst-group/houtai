    ...
    <div style="margin:0 1% 0 0; overflow:hidden">
      <div>
        <div class="button">
          ...
          <i-button class="search-btn btn" style="margin-right:10px" @click="handleSearch1">
        ...
        <div class="select">
          <a-form
            ...
            >
            <div style="float:left;width:260px;height:50px;margin-bottom:10px;">
            ...
            <div style="float:left;width:215px;height:50px;margin-bottom:10px;">
            ...
            <div style="float:left;width:190px;height:50px;margin-bottom:10px;">
              <span style="line-height:40px;margin-right:8px;">至</span>
              <a-form-item style="display:inline-block">
                <a-date-picker
                  placeholder="结束日期"
                  style="width: 160px"
            ...
            <div style="float:left;width: 311px;height:50px;margin-bottom:10px;">
    ...
    <div>
      ...
      >
        <div slot="recoveryList" slot-scope="text, record" style="text-align: center" class="slot-box show-text">
           <div style="margin-bottom: 10px" v-for="(v,k) in record.recoveryList" :key="k" v-show="k < 5 || record.showText === '收起'"><span>{{v.recoveryCode}}（{{v.batchName}}）</span></div>
