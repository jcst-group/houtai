            ...
            <div class="form-wrapper">
                <a-form-item label='农事名称'>
                    <a-input
                        ...
                        rules: [{required: true, message: '农事名称必须在20位内！',min:0,max:20}]
                    }]">
                    </a-input>
                </a-form-item>
            </div>
            ...
            <div class="form-wrapper">
                <a-form-item label='农事项目'>
                    ...
                    v-decorator="['farmingItemId',{
                        initialValue:record.farmingItem ? record.farmingItem.farmingName : '请先选择品种',
                ...
                <a-form-item label='备注'>
                    <a-textarea :autosize={minRows:2,maxRows:6} v-decorator="[
                        'remark',
                        {
                            ...
                            rules: [{required: false, message: '备注必须在200位内！',max:200}]
                        }
                    ]" />
                </a-form-item>
            </div>
