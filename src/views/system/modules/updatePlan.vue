            ...
            <a-tab-pane 
                ...
                <div class="plan-box">
                    ...
                    <div>
                        ...
                        :scroll="{y: 285 }"
                        >
                            <span slot="sequExecute" slot-scope="text,record">
                                <a-switch @change="val => changeQuene(val, record)" :defaultChecked='record.sequExecute'></a-switch>
                            </span>
    ...
    data() {
        return {
            ...
            farmingColumns: [
                ...
                {
                    title: '是否顺序执行',
                    dataIndex: 'sequExecute',
                    key: 'sequExecute',
                    scopedSlots: { customRender: "sequExecute" },
                    align: "center",
                    width: 127
                },
                {
