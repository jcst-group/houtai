            ...
            <div class="form-wrapper">
              <a-form-item label='种子批次'>
                <a-select
                  ...
                  :showSearch='true'
                  placeholder="请先选择品种名称"
                  v-decorator="[
                        'seedBatchId',
                            {
                                initialValue:record.seedBatchId,
              ...
              <a-form-item label='检测图片'>
                <div class="upload-wrapper">
                  <a-upload
                    ...
                    :showUploadList="true"
                    action="/api/pictureInfo/addSeedDetectionPic"
              ...
              <a-form-item label='检测报告'>
                <div class="upload-wrapper">
                  <a-upload
                    ...
                    class="avatar-uploader"
                    :showUploadList="true"
                    action="/api/pictureInfo/addSeedDetectionResultPic"
                    :beforeUpload="beforeUpload"
                    :headers="headers"
  ...
  export default {
    ...
    methods: {
      ...
      show(record){
        ...
        this.isUpfileListss=this.fileListss=record.detectionPic;
        let pictureInfoListRep = record.detectionResultPic;
        this.isUpfileListssRep=this.fileListssRep=record.detectionResultPic;
        let fileList = [];
        let file = {};
      ...
      open(record) {
        ...
        if (record !== undefined) {
          ...
          this.seedBatchId=record.seedBatchId;
          this.changeCrop(this.record.cropId);
      ...
      handleOk() {
        ...
        if (this.title === '新增') {
          ...
          params.detectionRelList=detectionRelList;
          delete params.crop
          if(this.isUpfileListss==null&&this.fileListss!=null){
            params.detectionPic=this.fileListss;
          }
          if(this.isUpfileListss!=null&&this.fileListss==null&&this.isUpfileListss.pictureUrl!=this.fileListss.pictureUrl){
            params.detectionPic=this.fileListss;
          }
          if(this.isUpfileListssRep==null&&this.fileListssRep!=null){
            params.detectionResultPic=this.fileListssRep;
          }
          if(this.isUpfileListssRep!=null&&this.fileListssRep==null&&this.isUpfileListssRep.pictureUrl!=this.fileListssRep.pictureUrl){
            params.detectionResultPic=this.fileListssRep;
          }
          this.getTime();
          params.detectionTime=this.detectionTime;
