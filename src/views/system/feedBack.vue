        ...
        <div style="margin-top:10px">
            ...
            >
                <span slot="action" slot-scope="text, record">
                    <a @click="handleFeedback(record)">
                        处理
                    </a>
                </span>
            </a-table>
        </div>
        <handleFeed ref="handleFeed"></handleFeed>
    </div>
</template>
<script>
import {getFeedBack, getFeedStatus} from '@/api/permissonApi.js'
...
export default {
    ...
    methods: {
        ...
        handleFeedback(record) {
            this.$refs.handleFeed.title = '反馈处理'
