          ...
          >
            <div class="upload-wrapper">
              <a-upload
                ...
                :showUploadList="true"
                action="/api/pictureInfo/addUserHeadPic"
          ...
          >
            <div class="upload-wrapper">
              <a-upload
                ...
                class="avatar-uploader"
                :showUploadList="true"
                action="/api/pictureInfo/addUserHukouPic"
                :beforeUpload="beforeUpload"
                :headers="headers"
          ...
          >
            <div class="upload-wrapper">
              <a-upload
                ...
                class="avatar-uploader"
                :showUploadList="true"
                action="/api/pictureInfo/addIdentifyCodePic"
                :beforeUpload="beforeUpload"
                :headers="headers"
  ...
  methods: {
    ...
    look(record) {
      ...
      if (record != " " && record != undefined) {
        ...
        //console.log(record)
        let imgshowapi = "/api/pictrueInfo/show";
        if (record.headPic) {
