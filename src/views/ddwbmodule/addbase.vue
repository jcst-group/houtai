    ...
    <div style="width:40%;float:left;margin-right:10px;">
      <a-form :form="form">
        ...
        >
          ...
          {
            rules: [{
              required: true, message: '基地名称必须在0~30位内！',min:0,max:30
            }]
          }
        ]"
          />
...
function getBase64 (img, callback) {
  ...
  import { getBaseCategoryEnum,getBaseTypeEnum,getChinaArea,getSecondArea,getSoilTypeEnum,getBaseAllTest,addBase,delPic } from '@/api/ddwbApi'
