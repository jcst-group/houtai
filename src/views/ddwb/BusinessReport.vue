...
export default {
    ...
    data(){
            ...
            return(
                <div style="width:100%;">
                    ...
                    <div style="width:100%;text-align:center">
                        ...
                        <span style="width:50%;padding:0 8px;display:inline-block">采收品产量(千克)</span>
                    </div>
                </div>
            )
        },
        ...
        title:()=>{
            return(
                    <div style="width:100%;font-size:16px;">人力成本(元)</div>
            )
        },
        align:'center',
        width:'10%',
    ...
    methods:{
        exporttale(){
            let par='';
            let api='/api/budget/businessExport';
            let realapi='';
            if(this.baseid){
