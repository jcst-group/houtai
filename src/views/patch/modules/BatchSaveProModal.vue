              ...
              <a-input
                v-decorator="[
                  'cropName',
                  {
                    ...
                    rules: [{
                      required: true, message: '请输入药材名称!',min:0,max:50
                    }]
                  }
                ]"
              />
        ...
        <a-row :gutter="24">
          <a-col :span="24">
            <a-form-item
              ...
              <a-upload
                name="file"
                action="/api/pictureInfo/addProCropPic"
                listType="picture-card"
                :fileList="mfileList"
                @preview="handlePreview"
                :headers="headers"
              ...
              if (this.record.cropPic) {
                if (!this.record.batchId) {
                  this.mfileList.push({
                    ...
                    status: 'done',
                    url: '/api/pictureInfo/show/'+this.record.cropPic.pictureUrl,
                  })
                } else {
                  this.record.cropPic.forEach(item => {
                    this.mfileList.push({
                      ...
                      status: 'done',
                      url: '/api/pictureInfo/show/'+item.pictureUrl,
                    })
                  })
                }
              }
