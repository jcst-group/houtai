...
const updateSequExecute = params => getAction('/farming/updateSequExecute', params)
...
const updateAllowedExecute = (params) => getAction('/workOrder/updateAllowedExecute', params)
const getOrderByApply = (params) => getAction('/orderApply/getOrderByApply', params)
const getOrderApply = (params) => getAction('/orderApply/getOrderApply', params)
const updateOrderApply = (params) => postAction('/orderApply/update', params)
const getWaitHandle = (params) => getAction('/resource/getWaitHandle', params)
...
const updateFeed = (params) => postAction('/feedBack/update', params)
