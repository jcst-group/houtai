<template>
  <a-layout id="components-layout-demo-custom-trigger" >
    ...
    <div class="logo" style="height:50px;background-color:transparent;">
      <span style="font-size:16px;color:#fff;margin-left:10px;line-height: 50px;" v-if="!collapsed">本草追溯平台</span>
    </div>
    <side-menu
      @addTab='addTab'
      :menus="menus"
    ...
    <a-layout style="overflow:auto;">
      ...
      <a-layout-header style="background: #fff; padding: 0; margin-top: 10px;boxShadow: 'rgba(0, 0, 0, 0.1) 0px 0px 5px';boxShadow: rgba(0, 0, 0, 0.1) 0px 0px 5px; min-width: 1200px">
      ...
      <a-layout-content style="box-sizing: border-box" :style="{minWidth: '1200px',padding: '20px',background: '#fff', transform: 'translate:(-50%, -50%)' }">
